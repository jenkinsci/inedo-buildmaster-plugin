 ...
 *         &lt;element name="IncludeGlobal_Indicator" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    "apiKey",
    "applicationId",
    "includeGlobalIndicator",
    "includeInactiveIndicator"
})
@XmlRootElement(name = "Workflows_GetWorkflows")
public class WorkflowsGetWorkflows {

    protected String apiKey;
    @XmlElement(name = "Application_Id", required = true, type = Integer.class, nillable = true)
    protected Integer applicationId;
    @XmlElement(name = "IncludeGlobal_Indicator")
    protected String includeGlobalIndicator;
    ...
    /**
     * Gets the value of the includeGlobalIndicator property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getIncludeGlobalIndicator() {
        return includeGlobalIndicator;
    }

    /**
     * Sets the value of the includeGlobalIndicator property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIncludeGlobalIndicator(String value) {
        this.includeGlobalIndicator = value;
    }
