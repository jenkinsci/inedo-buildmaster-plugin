 ...
 *         &lt;element name="ExecutionStatus_Name" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AdminEdit_UpdateExecutionStatus")
public class AdminEditUpdateExecutionStatus {

    protected String apiKey;
    @XmlElement(name = "Execution_Id", required = true, type = Integer.class, nillable = true)
    protected Integer executionId;
    @XmlElement(name = "ExecutionStatus_Name")
    protected String executionStatusName;
     ...
     *     
     */
    public void setExecutionStatusName(String value) {
